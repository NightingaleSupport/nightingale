...
router.get("/prototype", function(req, res, send) {
...
async function askteche(text) {
    var preface = [
        ...
        {role: "system", content: "You will only answer with context provided here."},
        {role: "system", content: "If someone asks a question that isnt about the Tech eChallenge, you will not respond, instead reprompting them to ask about the Tech eChallenge"},
